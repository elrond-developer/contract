...
const Actions = () => {
  ...
  const sendPingTransaction = async () => {
    const pingTransaction = {
      value: '0',
      data: 'proposeAsyncCall@15491faf33f6882d4096aeed137fb1ea2a27526cf13abf8c0544cef2aa801183@@455344545472616e73666572@44414e472d663235626233@d3c21bcecceda1000000',
          ...
          {hasPing && !hasPendingTransactions ? (
            <div className='action-btn' onClick={sendPingTransaction}>
              ...
              <a href='/' className='text-white text-decoration-none'>
                Propose MSC to Send ESDT DANG-91e9ab Token Back to Aadam
              </a>
            </div>
          ) : (
            <>
